  ...
  <div class="card border-danger">
    <br>
       <a href="student-outcomes.php">
           <img src="imgs/student-outcomes-card.png" width="90%" title="Analyze continuation, graduation rates, degrees received and more" alt="Out Stretched Hand Underneath Documents"></a>

    <div class="card-body text-center">
    <p class="card-text">Analyze continuation, graduation rates, degrees received and more<br>(Public dashboard)</p>
    </div>
  </div>
</div>
