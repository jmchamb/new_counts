...
<!-- DASHBOARDS BANNER -->  
  <div class="cont d-flex">
    <?//php include('inc/secondary-nav.php') ?></div></div>
     <h1 class="page-title">Content For Department Chairs</h1> </div>
...
<div class="d-flex">
  <div class="container mt-3">
	...
	<!-- Bread Crumbs -->
	<div align="left">
		&nbsp;&nbsp;<a href="./" style="color:black;font-size:18pt">CSUN Counts</a><font size="5">&nbsp;>&nbsp;</font><a href="tutorials.php" style="color:black;font-size:18pt">Help Page</a><font size="5">&nbsp;>&nbsp;Content For Department Chairs</font><br><br>
	</div>
  
 <!-- INTRO TO FACULTY -->  <div class="container" id="space-box">
    <div class="container-lg"> <p><h4 id="main">These are some dashboards that we have heard that Department Chairs find useful for their work. Please help us to curate this page by sending us your feedback on the usefulness of these dashboards and/or feedback on other dashboards that you find useful and why (email your feedback to <strong><a href="mailto:ir@csun.edu" class="text-danger">ir@csun.edu</a></strong>)</h4></p>
...
<div class="card-deck">
  ...
  <div class="redh mt-3 mb-4"><h2 class="redh mt-6"><strong>What does student success look like in your department?</strong></h3></div>
...
All faculty, staff, and administrators also have access to dashboards via their CSUN credentials.  You can access these by clicking on <strong><a href="https://counts.csun.edu" class="text-danger">https://counts.csun.edu</a></strong>.  Choose COUNTS after logging in, and take look at some of these dashboards.</strong>
<p></p></h4>

<h5 class="mt-3 mb-4"><strong>**TIP:  if you find a dashboard that you use often, click on the star to favorite it and then you can go straight to Favorites (left menu) to find it the next time you log on!**</strong></h5></div>
...
<div class="p-3 mt-2 mb-2 bg-white text-dark"><div class="redh mt-3 mb-4"><h2 class="redh mt-6"><strong>As a department chair, you have access to other content designed just for your work.  Some of these allow you to:</strong></h3></div></div>

    <div class="card-deck mb-5">
       <div class="card border-0 mr-5 " style="width:100%">
  </div>
  <div class="card mr-5 border-danger">
  ...
  <div class="card mr-5e border-danger">
    ...
    <div class="card-body text-center">
      <p class="card-text">Examine course-, section-, and instructor-level grade data on courses in your college</p>
    </div>
  </div>
