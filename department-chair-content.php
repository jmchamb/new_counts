...
<div class="d-flex">
 ...
 <!-- INTRO TO FACULTY -->  <div class="container" id="space-box">
    <div class="container-lg"> <p><h4 id="main">These are some dashboards that we have heard that Department Chairs find useful for their work. Please help us to curate this page by sending us your feedback on the usefulness of these dashboards and/or feedback on other dashboards that you find useful and why (email your feedback to <strong><a href="mailtoo:ir@csun.edu" class="text-danger">ir@csun.edu</a></strong>)</h4></p>
