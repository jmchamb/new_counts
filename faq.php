...
<div class="cont d-flex">
    <div class="home-banner mx-auto">
        <!--<img src="imgs/faq_banner.jpg" class="img-fluid"  alt="dashboard banner of broken down graph">-->
    </div> 
</div>
			...
			<div class="card">
			    <div class="card-header" id="heading4">
			      <p class="faq_question mb-0">
			        ...
			        <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#S"  style="color: #000;">State or Self Supported)</a></p> 
			       </p>
			    </div>
			...
			<div class="card">
			    <div class="card-header" id="heading8">
			      <p class="faq_question mb-0">
			        ...
			        <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F"  style="color: #000;">Full Time Equivalent Students/FTES)</a></p> 
			       </p>
			    </div>
			...
			<div class="card">
			    <div class="card-header" id="heading19">
			      <p class="faq_question mb-0">
			        ...
			        <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#C"  style="color: #000;">Census)</a></p> 
			       </p>
			    </div>
			...
			<div class="card">
			    <div class="card-header" id="heading21">
			      <p class="faq_question mb-0">
			        ...
			        <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F"  style="color: #000;">First Time Transfers/FTT)</a></p> 
			       </p>
			    </div>
