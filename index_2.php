  ...
  <div class="card border-danger">
    <br>
       <a href="https://www.csun.edu/institutional-research/explore-csun-data/snapshot-dashboard" target="_blank">
        <img src="imgs/snap-dash.png" width="90%" title="An interactive dashboard summarizing student characteristics" alt="Photos of Graph with a camera"></a>
  ...
  <div class="card border-danger">
    <br>
     <a href="https://www.csun.edu/institutional-research/explore-csun-data/fall-student-snapshot" target="_blank">
      <img src="imgs/fall-snap.png" width="90%" title="A downloadable infographic summarizing student characteristics" alt="magnifying glass"></a>
  ...
  <div class="card border-danger">
    <br>
       <a href="https://www.csun.edu/institutional-research/explore-csun-data/csun-profiles" target="_blank">
           <img src="imgs/csun-profiles.png" width="90%" title="A 2-page summary of enrollment, degrees awarded and more" alt="Out Stretched Hand Underneath Documents"></a>

    <div class="card-body text-center">
    <p class="card-text">  A 2-page summary of enrollment, degrees awarded and more<br>(Opens in a new window)</p>
    </div>
  </div>
  <div class="card border-danger"  style="text-align:center;">
    <br>
 ...
 <div class="redh id=tip"> <h1> Fully Interactive Dashboards</h1></div>
  ...
  <div class="card border-danger">
	<br>
        ...
        <img src="imgs/enrollment.png" width="90%" title="Dig into characteristics of all students or new student cohorts" alt="Photos of Graph with a camera"></a>
         <!--<button class="large-btn img-fluid" id="three">Continuation <br>Rates<br> Standard <br></button></a> -->
             <!--<img src="imgs/button-cards-03.jpg" alt="Generic placeholder image" width="100%"></a>-->
    <div class="card-body text-center">
  ...
  <div class="card border-danger">
    <br>
     <a href="registration-reports.php">
      <img src="imgs/regestration reports.png" width="90%" title="Explore registration day-by-day, year to year, and more" alt="magnifying glass"></a>
      <!-- <button class="large-btn img-fluid" id="four">Continuation <br>Rates<br> BYOR <br></button></a> -->
             <!-- <img src="imgs/button-cards-04.jpg" alt="Generic placeholder image" width="100%"></a> -->
    <div class="card-body text-center">
  ...
  <div class="card border-danger">
    <br>
       <a href="student-outcomes.php">
           <img src="imgs/student-outcomes-card.png" width="90%" title="Analyze retention, graduation rates, degrees received and more" alt="Out Stretched Hand Underneath Documents"></a>
...
<div class="card border-danger">
    <br>
       <a href="instruction-and-courses.php">
        <img src="imgs/instructions-and-corses.png" width="90%" title="Examine student-faculty ratios, section counts, and more" alt="Photos of Graph with a camera"></a>
        <!-- <button class="large-btn img-fluid" id="three">Continuation <br>Rates<br> Standard <br></button></a> -->
             <!-- <img src="imgs/button-cards-03.jpg" alt="Generic placeholder image" width="100%"></a> -->
    <div class="card-body text-center">
  ...
  <div class="card border-danger">
    <br>
     <a href="student-survey.php">
      <img src="imgs/student survey.png" width="90%" title="Explore students’ responses to surveys about engagement, post-graduation plans and more" alt="magnifying glass"></a>
      <!-- <button class="large-btn img-fluid" id="four">Continuation <br>Rates<br> BYOR <br></button></a> -->
             <!-- <img src="imgs/button-cards-04.jpg" alt="Generic placeholder image" width="100%"></a> -->
    <div class="card-body text-center">
  ...
  <div class="card border-danger">
    <br>
       <a href="faculty-data.php">
           <img src="imgs/faculty data.png" width="90%" title="Understand the characteristics of CSUN faculty, including by college or department" alt="Out Stretched Hand Underneath Documents"></a>
...
<div class="card-deck mb-5 col-lg-12">    
  <div class="card border-danger col-lg-4">
    <br>
       <a href="student-success-data-tools.php">
          <img src="imgs/student sucess data tools.png" width="90%" title="Explore what impacts student success including course outcomes, course pathways, courses new students struggle with, credit momentum, and major migration" alt="People in front of graphs"></a>
    <div class="card-body text-center">
  ...
  <div class="card border-danger col-lg-6">
    <br>
          <a href="https://counts.csun.edu" target="_blank"><img src="imgs/tableau_server.png" width="90%" title="Login to the Counts server to explore additional dashboards including tools for Chairs and Deans" alt="bar graph "></a>
    <div class="card-body text-center">
  ...
  <div class="card border-danger col-lg-4">
    <br>
       <a href="csu-system-dashboards.php">
          <img src="imgs/CSU system dashboards.png" width="90%" title="Dashboards out of the CSU system about student success and more" alt="bar graph "></a>
    <div class="card-body text-center">
...
<!--IR Glossary Link-->
<div class="row">
	<a href="ir-glossary.php"><img src="imgs/glossary.png" width="100%" alt="Take me to the IR Data Glossary" style="border:1px solid #D22030;" class="rounded"></a>
</div>
...
<div class="row">
	<a href="tutorials.php"><img src="imgs/helping-navigate-csun.png" width="100%" alt="Take me to the IR Help Navigating Page" style="border:1px solid #D22030;" class="rounded"></a>
</div>

<div><p>&nbsp;</p></div>

<!--Back to Legacy Counts pages-->
	<a href="https://www.csun.edu/counts/classic/index_2.php"><img src="imgs/button 1.png" width="90%" alt="Take me back to classic CSUN Counts" class="rounded"></a>
