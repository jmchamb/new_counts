...
<!-- DASHBOARDS BANNER -->  
  <div class="cont d-flex">
    <div class="home-banner mx-auto">
      <img src="imgs/tut.png" class="img-fluid"  alt="dashboard banner of broken down graph">
    </div>
  </div>
...
<?php include('inc/tut-quick.php') ?> <br>
 ...
 <div class="redh id=tip"> <h1>TIPSHEETS</h1></div>
 <div class="col-lg-6">
        <a href="imgs/001.pdf" target="blank"> 
          <button class="large-btn img-fluid" id="pdf-btn">Creating a Custom View for <br>IR Dashboards </button>
        </a>
      </div>
      <div class="col-lg-6">
     <a href="imgs/002.pdf" target="blank">
          <button class="large-btn img-fluid" id="pdf-btn">Expanding Dashboards to the College, Department, and Program Level </button>
        </a>
      </div>
 ...
 <div class="col-lg-12">
        <a href="https://www.youtube.com/watch?v=1qkb2AKaL0c&list=PLPRgbD4hILmAIyeDsph3AJB8vhzi5CTB5" target="blank"> 
          <button class="large-btn img-fluid" id="pdf-you">Check Out Our Video Tutorial Playlist</button>
        </a>
       <br> <strong>Our Video Tutorial Playlist Includes:</strong> <br>
       <p><a href="https://www.youtube.com/watch?v=1qkb2AKaL0c&list=PLPRgbD4hILmAIyeDsph3AJB8vhzi5CTB5&index=1" class="link-danger">Getting Started with CSUN Counts </a>,

        <a href="https://www.youtube.com/watch?v=tiy4VrHwImo&list=PLPRgbD4hILmAIyeDsph3AJB8vhzi5CTB5&index=2" class="link-danger">Navigating CSUN Counts </a>,

        Student Characteristics <a href="https://www.youtube.com/watch?v=g0qQoazNY8M&list=PLPRgbD4hILmAIyeDsph3AJB8vhzi5CTB5&index=3" class="link-danger">Part 1 </a>

         and <a href="https://www.youtube.com/watch?v=_50xviVDxQI&list=PLPRgbD4hILmAIyeDsph3AJB8vhzi5CTB5&index=4" class="link-danger">Part 2 </a>
      </div>
<div class="redh"id=add> <h1>CONTENT CURATED FOR SPECIFIC ROLES</h1></div>
 <div class="col-lg-4">
        <a href="new-faculty-content.php" target="blank"> 
          <button class="large-btn img-fluid" id="standard-btn">Content For<br>New Faculty </button>
        </a>
      </div>

      <div class="col-lg-4">
        <a href="dean-content.php" target="blank"> 
          <button class="large-btn img-fluid" id="byor-btn">Content For Deans<br> And Associate Deans </button>
        </a>
      </div>


      <div class="col-lg-4">
     <a href="department-chair-content.php" target="blank"> 
          <button class="large-btn img-fluid" id="reg-btn"> Content For <br>Department Chairs</button>
        </a>
      </div> </div>
    ...
    <div class="faq_accordion mx-auto" id="faq_section">
      ...
      <div class="card">
          ...
          <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#faq_section">
            ...
            change the years.<br>
            <a href="graduation-rates.php" >https://www.csun.edu/counts/graduation-rates.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          <div class="card-header" id="heading2">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F"  target="blank" style="color: #000;">First Time Freshman)</a></p> 
             </p>
          </div>
          ...
          <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#faq_section">
            ...
            <a href="continued_enrollment.php" >https://www.csun.edu/counts/continued_enrollment.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#faq_section">
            <div class="card-body ml-4">
              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);">
                To find the education level of parents use the Parental Education drop down menu at the bottom of the dashboard. This same drop down menu is found on the new and all student characteristics sections of CSUN Counts.<br>
            <a href="standard.php" > https://www.csun.edu/counts/standard.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          <div class="card-header" id="heading4">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#S" target="blank"  style="color: #000;">State or Self Supported)</a></p> 
             </p>
          </div>
      ...
      <div class="card">
          ...
          <div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#faq_section">
            ...
            <div class="card-body ml-4">
              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);">
                Use the Numbers drop down menu and select Average Unit Load.<br>
            <a href="current_undergraduate_students.php" >https://www.csun.edu/counts/current_undergraduate_students.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          <div class="card-header" id="heading8">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F"  target="blank" style="color: #000;">Full Time Equivalent Students/FTES)</a></p> 
             </p>
          </div>
      ...
      <div class="card">
          <div class="card-header" id="heading9">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#C"  target="blank" style="color: #000;">Continuation Rate)</a></p> 
             </p>
          </div>
  ...
  <!-- Q10 -->
       <div class="card">
          <div class="card-header" id="heading10">
            <p class="faq_question mb-0">
              <button class="btn btn-link btn-block text-left btn-wrap-text overflown-visible" type="button" data-toggle="collapse" data-target="#collapse10" aria-expanded="true" aria-controls="collapse9" style="font-size: min(4vw, 18px);">
               What’s the difference between Standard Dashboards and Build Your Own Reports? Why should I start from one versus the other?
              </button>
              </div>
          ...
          <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#faq_section">
            ...
            <div class="card-body ml-4">
              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);">
            Standard Dashboards show one way of displaying data. They often show historical trends over time. You can filter to specific groups based on a variety of fields. Build Your Own Reports allow you to customize how the data will be displayed – you can select what fields to use for columns and rows which allows you to disaggregate or break down the data to be displayed.
          </p>
            </div>
          </div>
      </div>
    ...
    <div class="faq_accordion mx-auto" id="faq_section">
          ...
          <div class="card-header" id="heading10">
            <p class="faq_question mb-0">
              <button class="btn btn-link btn-block text-left btn-wrap-text overflown-visible" type="button" data-toggle="collapse" data-target="#collapse10" aria-expanded="true" aria-controls="collapse10" style="font-size: min(4vw, 18px);">
               ...
               <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#G"  style="color: #000;">Graduation Rate)</a></p> 
             </p>
          </div>
      ...
      <div class="card">
          <div class="card-header" id="heading11">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#C"  style="color: #000;">Continuation Rate)</a></p> 
            </p>
          </div>
          ...
          <div id="collapse11" class="collapse" aria-labelledby="heading11" data-parent="#faq_section">
            ...
            <a href="continued_enrollment_rates_byor.php" >https://www.csun.edu/counts/continued_enrollment_rates_byor.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div id="collapse13" class="collapse" aria-labelledby="heading13" data-parent="#faq_section">
            <div class="card-body ml-4">
              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);">
                These numbers can found on all and new student characteristics dashboards. These students are First Generation Students (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F" >First Generation Student)</a>
              </p>

              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);"> To view these numbers use the Row Selection drop down menu and select First Generation Students. To view the gender on the row or column of the table use the drop down menus at the top of the dashboard.<br>
            <a href="byor.php" >https://www.csun.edu/counts/byor.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          <div class="card-header" id="heading14">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F)"  style="color: #000;">First Time Freshman)</a></p> 
             </p>
          </div>
          ...
          <div id="collapse14" class="collapse" aria-labelledby="heading14" data-parent="#faq_section">
            ...
            <a href="byor_first_time_freshmen.php" >https://www.csun.edu/counts/byor_first_time_freshmen.php</a>
          </p>
            </div>
          </div>
      </div>
      ...
      <div class="card">
          ...
          <div id="collapse15" class="collapse" aria-labelledby="heading15" data-parent="#faq_section">
            <div class="card-body ml-4">
              <p class="faq_answer text-left" style="font-size: min(4vw, 16px);">
                Use the Row Selection drop down menu and select Parent Education. This will show the headcounts. To view the percentage select Data Type Selection drop down menu and then scroll down to Percent (of Headcount). These percentages can be found on both All and New Student Characteristics dashboards.<br>
            <a href="byor.php" >https://www.csun.edu/counts/byor.php</a>
          </p>
            </div>
          </div>
      ...
      <div class="card">
          <div class="card-header" id="heading19">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#C"   target="blank" style="color: #000;">Census)</a></p> 
             </p>
          </div>
      ...
      <div class="card">
          <div class="card-header" id="heading21">
            <p class="faq_question mb-0">
              ...
              <p class="text-left ml-4" style="font-size: min(4vw, 14px);"> (definition here: <a href="https://www.csun.edu/csun-data/ir-glossary-terms#F"   target="blank" style="color: #000;">First Time Transfers/FTT)</a></p> 
             </p>
          </div>
